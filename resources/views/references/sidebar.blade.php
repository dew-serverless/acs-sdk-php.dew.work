<aside class="fixed pt-8 pb-16 w-80 bg-slate-50 overflow-auto overscroll-y-contain h-screen">
    <header class="flex px-4">
        ...
        <div class="ml-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#F7FBF7"><path fill="#75BDF5" d="M14.946 4.5C7.742 4.5 4 8.954 4 16.101 4 23.249 7.742 27.5 14.946 27.5 22.151 27.5 28 23.249 28 16.101 28 8.954 22.151 4.5 14.946 4.5Z"/></svg>
        </div>
    </header>
